...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='base', help='name of the model type. [pluralistic]')
        ...
        parser.add_argument('--preprocess', type=str, default='resize', help='preprocessing image at load time')
