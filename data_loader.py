...
class CreateDataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        # print(f"loading image {item % self.img_size}")
        ...
        # load the mask
        # print(f"loading mask {item % self.img_size}")
    ...
    def _load_mask(self, item, img):
        ...
        if mask_type == 0:                                  # center mask
            ...
            # print(f"mask path is {self.mask_paths[mask_index]}")
