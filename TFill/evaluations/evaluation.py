...
parser.add_argument('--gt_path', type=str, default='../results/M3_FFHQ_pretrained_TaylorSwift/test_latest/examples/img_org', help='path to original gt data')
parser.add_argument('--g_path', type=str, default='../results/M3_FFHQ_pretrained_TaylorSwift/test_latest/examples/img_ref_out', help='path to the generated data')
